        ...
        private fun migrations(): Array<Migration> {
            return arrayOf(
                ...
                object : Migration(10, 11) {
                    override fun migrate(database: SupportSQLiteDatabase) {
                        database.execSQL("""
                                CREATE TABLE IF NOT EXISTS RoomMediumProgress
                        ...
                        database.execSQL(
                            "CREATE INDEX index_RoomMediumProgress_mediumId ON RoomMediumProgress (mediumId);"
                        )
                        database.execSQL(
                            """CREATE INDEX index_RoomMediumProgress_currentReadIndex ON RoomMediumProgress (currentReadIndex);"""
                        )
                        database.execSQL("""
                                INSERT OR IGNORE INTO RoomMediumProgress 
                                SELECT RoomMedium.mediumId, MAX(RoomEpisode.combiIndex)
                                FROM RoomMedium
                ...
                object : Migration(11, 12) {
                    override fun migrate(database: SupportSQLiteDatabase) {
                        ...
                        database.execSQL(
                            """CREATE INDEX index_RoomMediumPart_mediumId ON RoomMediumPart (mediumId);"""
                        )
                        database.execSQL(
                            """CREATE INDEX index_RoomMediumPart_partId ON RoomMediumPart (partId);"""
                        )
                        database.execSQL(
                            """CREATE INDEX index_RoomPartEpisode_episodeId ON RoomPartEpisode (episodeId);"""
                        )
                        database.execSQL(
                            """CREATE INDEX index_RoomPartEpisode_partId ON RoomPartEpisode (partId);"""
                        )
                    }
                },
                object : Migration(12, 13) {
                    override fun migrate(database: SupportSQLiteDatabase) {
                        database.execSQL("""
                            CREATE TABLE IF NOT EXISTS RoomEditEvent 
                            (
                ...
                object : Migration(13, 14) {
                    override fun migrate(database: SupportSQLiteDatabase) {
                        database.execSQL("""
                            CREATE TABLE IF NOT EXISTS RoomToc 
                            (
